...
-- 1) Load StormCrimes_TrulyCleaned.csv (adjust path if necessary)
...
-- 2) Load Module Six CSV (export the Excel to CSV first)
-- Attempt filenames including spaces or with "COMPLETE" portion.
-- Name your exported CSV one of these (and adjust path below if you use a different name):
--   data/DAT 375 Module Six Assignment Data Set.csv
--   data/DAT 375 Module Six Assignment Data Set COMPLETE.csv

LOAD DATA LOCAL INFILE 'data/DAT 375 Module Six Assignment Data Set.csv'
